"""
Django settings for prtest_107 project.
...
WSGI_APPLICATION = 'prtest_107.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prtest_107 API",
    "DESCRIPTION": "API documentation for prtest_107 App",
    "VERSION": "v1",
}
